...
cal, weights = create_synthetic_control(train_df, inverted, state_pools, 
                                        model = model, state = 'California')
...
cal, weights = create_synthetic_control(train_df, inverted, state_pools, 
                                        model = model_EN, state = 'California')
...
model_EN = ElasticNet(fit_intercept=False, positive = True)
cal_non_outlier, weights = create_synthetic_control(train_df, inverted, non_outlier_state, 
                                        model = model_EN, 
                                        state = 'California')
...
model_EN = ElasticNet(fit_intercept=False, positive = True)
mon_non_outlier, mon_weights = create_synthetic_control(train_df, inverted, non_outlier_state_MO, 
                                        model = model_EN, 
                                        state = 'Montana')
